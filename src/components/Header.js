    ...
    render() {
        return (
            <div>
                ...
                <li class="social-list__item"><a class="social-list__link" href=""><img class="img-header" src="https://cdn.goadventureturkey.com/goturkey/static/images/turkiye-dark.svg"/></a></li>
