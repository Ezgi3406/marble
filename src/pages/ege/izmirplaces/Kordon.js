      ...
      <div className="background">
        ...
        <div style={{ display: "grid", "grid-template-columns": "1fr 1fr" }}>
          <Col xs={40} sm={15} className="marmara-wrapper">
            <Image
              src="https://global-geography.org/attach/Geography/Asia/Turkey/Pictures/Izmir_Milet_Bodrum/Izmir_-_Kordon_3/WT1025_Kordon_Izmir.jpg"
              style={{
                height: "600px",
                width: "900px",
                padding: "60px",
        ...
        <Container>
          <Row className="show-grid text-center">
            <Col xs={12} sm={3} className="person-wrapper">
              <Image
                src="https://upload.wikimedia.org/wikipedia/commons/thumb/3/35/TR_Izmir_asv2020-02_img16_Alsancak_seaside.jpg/1200px-TR_Izmir_asv2020-02_img16_Alsancak_seaside.jpg"
                style={{ height: "274px"}}
                square
                className="profile-pic"
              />
            ...
            <Col xs={12} sm={3} className="person-wrapper">
              <Image
                src="https://media.istockphoto.com/photos/elevated-view-of-izmir-kordon-turkey-picture-id945893240?k=20&m=945893240&s=170667a&w=0&h=QUHD7tCPzXRXf__HJLg61LaLurULzLib_r2dXcoq1VU="
            ...
            <Col xs={12} sm={3} className="person-wrapper">
              <Image
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ364l2NfbIVZeyjOkfY27XLdus-E-1ldGqEZB1GwZvt27Rvj1lp2dzzyzhmhQKRF1vz10&usqp=CAU"
                style={{ height: "274px"}}
                square
                className="profile-pic"
              />
            ...
            <Col xs={12} sm={3} className="person-wrapper">
              <Image
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRF7GUtEvI64suu3XrwI5R-4LB4fvJYbeMYwIepDlNlzvqWtvlPfB2XssxBeecfRXGhAEc&usqp=CAU"
                style={{ height: "274px" }}
                square
                className="profile-pic"
              />
