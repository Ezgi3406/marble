        ...
        <div style={{ display: "grid", "grid-template-columns": "1fr 1fr" }}>
          ...
          <Row className="show-grid text-center">
            <Col xs={12} sm={3} className="person-wrapper">
              <Image
                src="http://localhost:3000/assets/img/places/1-hierapolis-ancient-city-5.jpg" style={{height:"274px" }}
                square
                className="profile-pic"
              />
              <>
            ...
            <Col xs={12} sm={3} className="person-wrapper">
              <Image
                src="http://localhost:3000/assets/img/places/3-liste-hierapolis-ancient-city-2.jpg"  style={{height:"274px" ,width:"250px"}}
                square
                className="profile-pic"
              />
              <>
