      ...
      <div className="background">
        ...
        <div style={{ display: "grid", "grid-template-columns": "1fr 1fr" }}>
          <Col xs={40} sm={15} className="marmara-wrapper">
            <Image
              src="https://youimg1.tripcdn.com/target/10041f000001gp9pnA162.jpg?proc=source%2Ftrip"
              style={{
                height: "600px",
                width: "900px",
                padding: "60px",
        ...
        <Container>
          <Row className="show-grid text-center">
            ...
            <Col xs={12} sm={3} className="person-wrapper">
              <Image
                src="https://upload.wikimedia.org/wikipedia/commons/thumb/e/e0/TR_Pamukkale_Hierapolis_asv2020-02_img29.jpg/800px-TR_Pamukkale_Hierapolis_asv2020-02_img29.jpg"
                style={{ height: "274px" }}
                square
                className="profile-pic"
              />
            ...
            <Col xs={12} sm={3} className="person-wrapper">
              <Image
                src="https://previews.123rf.com/images/cascoly2/cascoly21407/cascoly2140702375/30294863-monumental-tomb-in-the-necropolis-of-hierapolis-turkey.jpg"
