      ...
      <div className="background">
        ...
        <div style={{ display: "grid", "grid-template-columns": "1fr 1fr" }}>
          <Col xs={40} sm={15} className="marmara-wrapper">
            <Image
              src="http://localhost:3000/assets/img/places/bodrumkalesi2.jpg"
              style={{
                height: "600px",
                width: "900px",
                padding: "60px",
        ...
        <Container>
          <Row className="show-grid text-center">
            <Col xs={12} sm={3} className="person-wrapper">
              <Image
                src="http://localhost:3000/assets/img/places/bodrumkalesi3.jpg"
                style={{ height: "274px" }}
                square
                className="profile-pic"
              />
            ...
            <Col xs={12} sm={3} className="person-wrapper">
              <Image
                src="http://localhost:3000/assets/img/places/Bodrum-Kalesi1.jpg"
                style={{ height: "274px" }}
                square
                className="profile-pic"
              />
            ...
            <Col xs={12} sm={3} className="person-wrapper">
              <Image
                src="http://localhost:3000/assets/img/places/bodrumkalesi5.jpg"
            ...
            <Col xs={12} sm={3} className="person-wrapper">
              <Image
                src="http://localhost:3000/assets/img/places/bordumkalesi6.jpg"
                style={{ height: "274px" }}
                square
                className="profile-pic"
              />
